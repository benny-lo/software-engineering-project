...
public class ControllerTest {
    ...
    *//**
    ...
    public void testSuccessfulJoinAction(){
        ...
        // ServerConnection Sender0 = new SenderClientTesting(client0);
        // VirtualView view0 = new VirtualView(lobby);
        // view0.setToClient(Sender0);
        // controller.update(new JoinAction(view0.getNickname(), view0));

        // ClientTesting client1 = new ClientTesting();
        // ServerConnection Sender1 = new SenderClientTesting(client1);
        VirtualView view1 = new VirtualView(lobby);
    ...
    *//**
    ...
    public void testUnsuccessfulJoinAction1() {
        ...
        // ServerConnection Sender2 = new SenderClientTesting(client2);
        VirtualView view2 = new VirtualView(lobby);
