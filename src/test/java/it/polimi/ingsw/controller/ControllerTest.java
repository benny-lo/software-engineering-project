...
public class ControllerTest {
    ...
    public void testLivingRoomGameAlreadyEnded() {
        ...
        SelectedItems selectedMessage = null;
        Message message;

        while(!mock0.queue.isEmpty()) {
            message = mock0.queue.remove();
            if (message instanceof SelectedItems)
                selectedMessage = (SelectedItems) message;
        }

        assertNull(selectedMessage.getItems());
    }
    ...
    public void testLivingRoomSuccessfully() {
        ...
        assertNotEquals(Item.LOCKED, selectedMessage.getItems().get(0));
        assertNotNull(selectedMessage.getItems());
    }
    ...
    public void testBookshelfGameAlreadyEnded() {
        ...
        AcceptedInsertion selectedMessage = null;
        Message message;

        while(!mock0.queue.isEmpty()) {
            message = mock0.queue.remove();
            if (message instanceof AcceptedInsertion)
                selectedMessage = (AcceptedInsertion) message;
        }

        assertFalse(selectedMessage.isAccepted());
    }
    ...
    public void testBookshelfSuccessfully() {
        ...
        assertTrue(selectedMessage.isAccepted());
    }

    //TODO: i will fix it. -vincenzo
//    /**
...
//        controller.join(view2);
//
//        GameData failedJoin = (GameData) mockServerConnection2.queue.poll();
...
//        List<Message> list1 = new ArrayList<>(mockServerConnection0.queue);
//        controller.livingRoom(pos, view0);
//        assertEquals(list1.size(),mockServerConnection0.queue.size()-1);
//        for(Message message : mockServerConnection0.queue)
//        {
//            if(!(message instanceof SelectedItems))
//            {
